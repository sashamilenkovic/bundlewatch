...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxtjs+mdc@0.9.5_magicast@0.5.1/node_modules/@nuxtjs/mdc/dist/runtime/components/prose/ProseScript.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ProseScript = Object.assign(_sfc_main, { __name: "ProseScript" });

export { ProseScript as default };
//# sourceMappingURL=ProseScript-CFAsUsAt.mjs.map
